        ...
        <>
            ...
            <section className="sp-hero">
                <div className="sp-hero__bg">
                    <Image src="/images/about/varanashi-compressed.jpg" alt="The ancestral Varanashi house — a testament to over 200 years of heritage" fill sizes="100vw" priority />
                </div>
            ...
            {/* ═══════════ THE FARM (with building image) ═══════════ */}
            <section className="sp-section">
                <div className="sp-section__inner">
                    <div className="sp-split">
                        <div className="sp-split__image">
                            <Image src="/images/about/heritage-building.jpg" alt="Organic farming at Varanashi" fill sizes="50vw" />
                        </div>
            ...
            {/* ═══════════ FAMILY HISTORY (with family photo) ═══════════ */}
            <section className="sp-section sp-section--alt">
                <div className="sp-section__inner">
                    <div className="sp-split sp-split--reverse">
                        <div className="sp-split__image">
                            <Image src="/images/about/family-pic.jpg" alt="The Varanashi family — six generations of organic farming heritage" fill sizes="50vw" />
                        </div>
                        <div className="sp-split__text">
            ...
            {/* ═══════════ THE INSPIRATION (with V.S. Bhat photo) ═══════════ */}
            <section className="sp-section">
                <div className="sp-section__inner">
                    <div className="sp-split">
                        <div className="sp-split__image">
                            <Image src="/images/about/campco-bhat.jpg" alt="Sahakari Rathna Shri V. S. Bhat with President Zail Singh" fill sizes="50vw" />
                        </div>
                        <div className="sp-split__text">
                            ...
                            <div className="sp-highlight">
                                <p>V. S. Bhat with President Zail Singh</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="sp-section sp-section--alt">
                <div className="sp-section__inner">
                    <div className="sp-split sp-split--reverse">
                        <div className="sp-split__image">
                            <Image src="/images/about/varanashi-compressed.jpg" alt="The ancestral Varanashi house at Moodambailu" fill sizes="50vw" />
                        </div>
                        <div className="sp-split__text">
            ...
            <section className="sp-section">
                <div className="sp-section__inner">
                    <div className="sp-split">
                        <div className="sp-split__image">
                            <Image src="/images/about/farm-view.jpg" alt="Organic farm landscape at Varanashi" fill sizes="50vw" />
                        </div>
                        <div className="sp-split__text">
            ...
            <section className="sp-section sp-section--alt">
                <div className="sp-section__inner">
                    ...
                    <div className="sp-gallery">
                        <div className="sp-gallery__item"><Image src="/images/about/varanashi-compressed.jpg" alt="The ancestral Varanashi house" fill sizes="33vw" /></div>
                        <div className="sp-gallery__item"><Image src="/images/about/family-pic.jpg" alt="The Varanashi family" fill sizes="33vw" /></div>
                        <div className="sp-gallery__item"><Image src="/images/about/campco-bhat.jpg" alt="V. S. Bhat with President Zail Singh" fill sizes="33vw" /></div>
                        <div className="sp-gallery__item"><Image src="/images/about/heritage-building.jpg" alt="Organic farming" fill sizes="33vw" /></div>
